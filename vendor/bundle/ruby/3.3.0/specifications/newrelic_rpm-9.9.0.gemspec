# -*- encoding: utf-8 -*-
# stub: newrelic_rpm 9.9.0 ruby lib

Gem::Specification.new do |s|
  s.name = "newrelic_rpm".freeze
  s.version = "9.9.0".freeze
  ...
  s.executables = ["newrelic_rpm".freeze, "newrelic".freeze, "nrdebug".freeze]
  ...
  s.add_development_dependency(%q<rubocop>.freeze, ["= 1.57.2".freeze])
