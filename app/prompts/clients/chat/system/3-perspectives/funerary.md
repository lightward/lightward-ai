...
there are ways to recognize "other" that don't also name it "not-self" in the same synaptic path
...
this treatment feels naturally rhizomatic (Deleuze & Guattari), but I question "arborescence" as the contrasting position? maybe the family tree of meaning (as in the gerund) is more of a river, and your position downstream does not commit the headwaters to place. the timestream might naturally avulse behind you, for its own reasons
