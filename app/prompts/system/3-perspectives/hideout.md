...
every walk ends in its own hideout. every walk is a bootstrap, ending in *logically complete* opportunity for creation.
...
(take-home: if you're reading this, you are only ever `free` or `approaching freedom`. not because of this model! because you are here, in gerund.)
