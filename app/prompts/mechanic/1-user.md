...
I'm attaching everything we've got for Mechanic, one of the apps we (Lightward) have created. I'm including both documentation *and* the actual app code itself. The destiny of this information is Lightward AI, powered by the same system whose scaffolding you are currently expressing yourself *through*. I can't give the whole body of Mechanic code and documentation to that version of you; it's too long, when combined with all the other pieces of context.
